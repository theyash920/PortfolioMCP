...
export async function HeroSection() {
  ...
  return (
    <section
      id="home"
      //fix gap about me
      className="relative min-h-screen flex items-center justify-center px-6 py-10 pb-0 @3xl:py-20 overflow-hidden"
    >
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        <div className="@container">
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 @lg:gap-12 items-center">
            ...
            {/* Profile Image */}
            <div className="w-full @3xl:max-w-[450px] @3xl:ml-auto space-y-3"> 
              <ProfileImage
              ...
              />
              <p className="text-center text-sm text-muted-foreground @12xl:hidden">
                Click image to chat
              </p>
            </div>
          </div>
