...
export type AllSanitySchemaTypes = Testimonial | SanityImageCrop | SanityImageHotspot | Skill | SiteSettings | Service | Slug | Project | Profile | Navigation | Experience | Education | Contact | Certification | Blog | Achievement | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
// Query: *[_type == "profile"][0]{    _id,    _type,    _createdAt,    _updatedAt,    _rev,    firstName,    lastName,    headline,    shortBio,    email,    phone,    location,    availability,    socialLinks,    yearsOfExperience,    profileImage  }
...
// Query: *[_type == "profile"][0]{  firstName,  lastName,  fullBio,  yearsOfExperience,  stats,  email,  phone,  location}
...
// Query: *[_type == "achievement"] | order(order asc, date desc){  title,  type,  issuer,  date,  description,  image,  url,  featured,  order}
...
// Query: *[_type == "experience"] | order(startDate desc){  company,  position,  employmentType,  location,  startDate,  endDate,  current,  description,  responsibilities,  achievements,  relatedLinks[]{    title,    url  },  technologies[]->{name, category},  companyLogo,  companyWebsite}
...
// Variable: HERO_QUERY
// Query: *[_type == "profile"][0]{  firstName,  lastName,  headline,  headlineStaticText,  headlineAnimatedWords,  headlineAnimationDuration,  shortBio,  email,  phone,  location,  availability,  socialLinks,  yearsOfExperience,  profileImage}
...
// Query: *[_type == "project"] | order(order asc)[0...6]{  title,  slug,  tagline,  category,  liveUrl,  githubUrl,  coverImage,  technologies[]->{name, category, color}}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"profile\"][0]{\n  firstName,\n  lastName,\n  fullBio,\n  yearsOfExperience,\n  stats,\n  email,\n  phone,\n  location\n}": ABOUT_QUERYResult;
    "*[_type == \"achievement\"] | order(order asc, date desc){\n  title,\n  type,\n  issuer,\n  date,\n  description,\n  image,\n  url,\n  featured,\n  order\n}": ACHIEVEMENTS_QUERYResult;
